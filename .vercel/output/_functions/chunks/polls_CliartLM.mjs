...
//#region src/pages/api/voting/polls.ts
var polls_exports = /* @__PURE__ */ __exportAll({ GET: () => GET });
var GET = async () => {
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/voting/polls@_@ts
var page = () => polls_exports;
//#endregion
export { page };
