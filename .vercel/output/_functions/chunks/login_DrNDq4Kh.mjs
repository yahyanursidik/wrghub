...
import { f as renderHead, i as renderComponent, u as renderTemplate, x as createAstro } from "./server_D9_Gh2WS.mjs";
...
var $$Login = createComponent(($$result, $$props, $$slots) => {
	...
	Astro.self = $$Login;
	const portal = Astro.url.searchParams.get("portal") === "admin" ? "admin" : "resident";
	return renderTemplate`<html lang="id"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Masuk - WargaHub Taman Sejahtera</title><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">${renderHead($$result)}</head><body class="bg-canvas text-ink font-sans min-h-screen antialiased selection:bg-primary-100 selection:text-primary-900">${renderComponent($$result, "UnifiedLoginView", UnifiedLoginView, {
...
}, "C:/Users/P R E D A T O R/Documents/wargahub/src/pages/login.astro", void 0);
var $$file = "C:/Users/P R E D A T O R/Documents/wargahub/src/pages/login.astro";
var $$url = "/login";
//#endregion
