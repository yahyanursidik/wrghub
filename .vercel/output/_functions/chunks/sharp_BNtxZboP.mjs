import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_Cs4nkOiz.mjs";
import { y as detector } from "./path_B7MjsYFm.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_0MDSOj1F.mjs";
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._2e9d5d44ff3d165f51a15da3c85e950a/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_BsiWX2q7.mjs")).default;
	} catch {
