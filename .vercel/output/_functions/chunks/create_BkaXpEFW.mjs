...
import { z } from "zod";
//#region src/pages/api/properties/utilities/create.ts
var create_exports = /* @__PURE__ */ __exportAll({ POST: () => POST });
var utilitySchema = z.object({
	...
	monthlyIplFee: z.number().default(75e4),
...
var POST = async ({ request }) => {
	try {
		...
		const newUtility = {
			...
			plnCustomerId: validated.plnCustomerId || `PLN-5388${Math.floor(1e5 + Math.random() * 9e5)}`,
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/properties/utilities/create@_@ts
